...
Accessibility is providing the ability to access websites by anyone. 

2. Talk about 3 different things you can do to ensure your website is accessible. 

Some of the 3 different things that ensures a website's accesibility are color, using right structure headings, and alt tags to images.

3. How would you explain the concept of a variable to someone new to programming?

Much like math, variable contains a value that we use. var varible = value;

4. What is the purpose of using functions in code?


The purpose of using functions in code is the perform a certain task, within its module when invoked. Takes in data and puts out a new generated one. 
